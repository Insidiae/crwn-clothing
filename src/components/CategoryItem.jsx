...
function CategoryItem({ category }) {
	return (
		<div className="min-w-[30%] h-60 flex-auto flex justify-center items-center border border-black mt-0 mx-2 mb-4 overflow-hidden hover:cursor-pointer group first:mr-2 last:ml-2">
			<img
			...
			<div className="absolute h-24 py-0 px-6 flex flex-col justify-center items-center border border-black bg-white opacity-70 group-hover:opacity-90">
				<h2 className="font-bold mx-2 text-2xl text-neutral-700">
					{category.title}
				</h2>
